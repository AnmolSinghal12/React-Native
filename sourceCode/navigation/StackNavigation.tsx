...
import InternPersonalInfo from '../screens/allScreens/Intenship/InternPersonalInfo';
import InternHome from '../screens/allScreens/Intenship/InternHome';
import EduDetails from '../screens/allScreens/Intenship/Education';
import SubscriptionPlan from '../screens/allScreens/Intenship/SubscriptionPlan';
import BottomTabOurInternshipProgram from '../screens/allScreens/Intenship/BottomTabOurInternshipProgram';
import BottomTabEnrolledProgramScreen from '../screens/allScreens/Intenship/BottomTabEnrolledProgramScreen';
import BottomTabProfileAccountScreen from '../screens/allScreens/Intenship/BottomTabProfileAccountScreen';
import InternTabNavigation from '../screens/mainStack/TabNavigation/InternTabNavigation';
    ...
    return (
        <RootSiblingParent>
            <Stack.Navigator
                ...
                // initialRouteName='BottomTabProfileAccountScreen'
            ...
            >
                ...
                <Stack.Screen name='InternPersonalInfo' component={InternPersonalInfo} />
                <Stack.Screen name='EduDetails' component={EduDetails} />
                <Stack.Screen name='InternHome' component={InternHome} />
                <Stack.Screen name='JobInfo' component={JobInfo} />
                <Stack.Screen name='TabNavigation' component={TabNavigator} />
                <Stack.Screen name='InternTabNavigation' component={InternTabNavigation} />
                <Stack.Screen name='BottomTabProfileAccountScreen' component={BottomTabProfileAccountScreen} />
                <Stack.Screen name='BottomTabEnrolledProgramScreen' component={BottomTabEnrolledProgramScreen} />
                <Stack.Screen name='BottomTabOurInternshipProgram' component={BottomTabOurInternshipProgram} />
